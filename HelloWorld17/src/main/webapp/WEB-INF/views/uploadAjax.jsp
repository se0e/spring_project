					...
					$.ajax({
						...
						success:function(data){
							...
							if(checkImageType(data)){
								...
								str="<div><a href='displayfile?fileName="+data+"'><img src='../resources/img/gagi.jpg' style='width:100px;height:100px;'/>"+getOriginalName(data)+"</a><small data-src='"+data+"'>X</small ></div>";
							}
